...
public class GameProgress
{
    ...
    public void InitializeGameData()
    {
        if (miniGames == null)
        {
            ...
            miniGames[1] = new MiniGame(1, "find-alex", "Finde Alex", "Hilf Emma Alex zu finden. Du kannst zwei zusätzliche Sterne verdienen, wenn du genau herumschaust und auch den anderen hilfst.", 0, 1, flour);
            miniGames[2] = new MiniGame(2, "combination", "Kombiniere richtig", "Setze die einzelnen Stücke zusammen, indem du die Karten richtig drehst und zusammensetzt.", 0, 1, hazelnut);
            miniGames[3] = new MiniGame(3, "maze", "Küchen Minigolf", "Spiele Minigolf in der Küche von Alex.", 0, 1, honey);
